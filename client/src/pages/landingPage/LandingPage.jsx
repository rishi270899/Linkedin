...
//         {/* Google Button */}
//         {/* className="flex items-center justify-center gap-3 w-full md:w-[80%] bg-blue-600 border border-gray-300 rounded-full py-2 px-4 text-white font-medium cursor-pointer hover:bg-blue-700 transition mb-3" */}
//         <div >
//           {/* <img
//             src="/google_logo.png"
//             alt="Google logo"
...
//         {/* Email Sign In */}
//         <Link to={'/signup'} className="w-full md:w-[80%] bg-white border border-gray-300 rounded-full py-2 px-4 text-center text-black font-medium cursor-pointer hover:bg-gray-100 transition mb-3">
//           Sign in with email
//         </Link>
...
const LandingPage = () => {
  return (
    <div className="pt-10 md:pt-16 px-5 md:px-20 flex flex-col md:flex-row items-center justify-center gap-10 bg-gray-50 min-h-screen">
      ...
      <div className="w-full md:w-1/2 mb-5 flex flex-col items-center md:items-start justify-center text-center md:text-left">
        ...
        <Link
          to="/signup"
          className="w-full md:w-[80%] bg-white border border-gray-300 rounded-full py-2 px-4 text-center text-black font-medium cursor-pointer hover:bg-gray-100 transition mb-3"
        >
          Sign in with email
        </Link>
        ...
        <p className="text-sm text-gray-600 mt-4 w-full md:w-[80%]">
          By clicking continue to join or sign in, you agree to
          <span className="text-[#0374b3] cursor-pointer hover:underline pl-1">
        ...
        <div className="text-md mt-5 w-full md:w-[80%]">
          ...
          <Link
            to="/signup"
            className="text-[#0374b3] cursor-pointer pl-1 hover:underline"
          >
            Sign Up
          </Link>
        </div>
